...
<template>
  <div class="base-textarea relative border-2 border-gray-300 rounded">
    ...
    <textarea
      ...
      :cols="cols"
    />
    <span class="placeholder absolute left-3 top-0 transform -translate-y-2 text-xs bg-[#ffffff] px-2">{{
      label
    }}</span>
  </div>
</template>
